<?php include('header.php'); ?>
    <title>ជីវិត និងសង្គម - Sabay News</title>
</head>
<body>
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 left-content top-title">
                <div class="top-category">
                    ...
                    <div class="top-cate-line" style="background-color: #F9A62B;"></div>
                </div>
            </div>
                                    ...
                                    <a href="./details.php" class="col-xl-12 col-lg-12 col-md-6 col-sm-6 col-6 post-list">
                                            <div class="row">
                                                ...
                                                <div class="post-list-img">
                                                    <img src="<?php echo "./assets/img/entertainment/entertainment1.jpg";?>" alt="" style="width:100%;">
                                                </div>
